...
Leaf1 =new Image();
Leaf1 = allTypeOfLeaves[0] = "/img/leaf.png";//path to the image you will use
...
for (i = 0 ;i < numberOfLeaves;i++){
  ...
  if (typeOfLeaf == 3)
   ...
   document.body.insertAdjacentHTML('afterBegin', '<img class="leaves leaves'+i+'" src="'+rndLeaf+'" style="background-color:none;position:absolute;top:'+Ypos[i]+'px;left:'+Xpos[i]+'px;height:'+height[i]+'px;width:'+width[i]+'px;opacity:'+opacityLeaf[i]+';">');
